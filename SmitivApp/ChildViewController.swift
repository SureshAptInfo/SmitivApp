...
class ChildViewController: UIViewController, UIScrollViewDelegate {
    ...
    var ListCollection : ListCollectionViewCell! = ListCollectionViewCell()
...
extension ChildViewController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
